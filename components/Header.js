...
export default function Header() {
	const onCallButtonClicked = () => {
	    window.centilio_connector_init.submit_call()
	}
	return(
		<div className="py-[20px] bg-[#ffffff] flex justify-between items-center top-[0px] sticky">
			...
			<a href="tel:+91 7418059444" id="callUsNowButton">
				<div className="call-us-button bg-[#E6A424] h-fit flex items-center py-[10px] px-[20px] rounded-[5px] cursor-pointer sm:text-[18px] font-medium" onClick={onCallButtonClicked}>
