...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r lg:border-r-[#1e62afa6] py-10 relative group/feature dark:border-neutral-800",
    ...
    >
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-300 max-w-xs relative z-1 px-10">
        {description}
      </p>
    </div>
  );
