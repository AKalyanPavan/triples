...
import fold7image1 from '@/images/commercial-landing-page2/fold7image1.png'
	...
	return(
		<div className="flex justify-between mx-auto my-[100px] items-center lg:gap-10">
			<div className="max-lg:mx-auto">
				<HeadingMultiColour customStyle="lg:text-[48px] md:text-[36px] text-[24px] max-lg:text-center" textLeft="Financing " textRight="That Works for You" />
