...
import fold4image1 from '@/images/residential-landing-page2/fold4image1.png'

import fold4image2 from '@/images/residential-landing-page2/fold4image2.svg'
import fold4image3 from '@/images/residential-landing-page2/fold4image3.svg'
...
export default function Fold4() {
	return(
		<div className="flex lg:gap-[50px] justify-center mx-auto my-[100px] items-center">
			<div>
				<ShiningText customStyle="md:text-[36px] text-[32px] font-medium text-center" textLeft={""} textRight={"Ready to Cut Your Energy Costs and Boost Your Bottom Line?"} />
