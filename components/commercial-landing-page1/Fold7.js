...
import fold7image1 from '@/images/commercial-landing-page1/fold7image1.png'
import bulletPoint from '@/images/commercial-landing-page1/bullet-point.svg'
	...
	return(
		<div className="flex justify-between mx-auto my-[100px] items-center lg:gap-10">
			<div className="max-lg:mx-auto">
				<HeadingMultiColour customStyle="lg:text-[48px] md:text-[36px] text-[24px] max-lg:text-center" textLeft="Flexible " textRight="Financing Options" />
