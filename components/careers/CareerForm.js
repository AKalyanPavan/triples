      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-white rounded-md shadow-lg p-8 w-full max-w-md text-center">
          ...
          <button
            ...
            className="w-full bg-[#1E62AF] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-md transition-colors cursor-pointer"
          >
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md text-center">
          ...
          <button
            onClick={resetSubmissionStatus}
            className="w-full bg-[#1E62AF] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors cursor-pointer"
          >
            Try Again
          </button>
        </div>
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="pt-6">
                <button
                  ...
                  style={{
                    backgroundColor: isLoading ? '#9CA3AF' : '#1E62AF',
                  }}
                  onMouseEnter={(e) => {
                    if (!isLoading) {
                  ...
                  onMouseLeave={(e) => {
                    if (!isLoading) {
                      e.target.style.backgroundColor = '#1E62AF';
                    }
                  }}
                >
                  {isLoading ? (
